<template>
  <div class="user-rules">
    ...
    <div class="user-rules-box">
      ...
      <h6 class="title-h6">Now – Feb. 1st, 2022, Ends in 60 days</h6>
      <p>
      ...
      <h6 class="title-h6">IBXC:IBAX Main network Coin</h6>
      <h6 class="user-rules-item title-h6">
        <span>
          Jackpot A <br />
