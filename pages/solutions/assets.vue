 ...
 * @LastEditors: abc
 * @LastEditTime: 2021-11-19 20:29:11
          ...
          >
            ...
            <el-col :xs="24" :lg="12">
              <div class="home-new-img wow fadeInUp">
                <img src="@/assets/images/assets-2.png" alt="assets-2" />
              </div>
            </el-col>
          </el-row>
        </div>
        ...
        <el-col :xs="23" :lg="15">
          ...
          <div class="other-center-box wow fadeInUp">
            <strong class="other-center-box-strong">
              {{ $t('solutions.risk') }}</strong
            >
            <span>{{ $t('solutions.structured') }}</span>
          </div>
        </el-col>
      </el-row>
    </div>
          ...
          <div class="home-new">
            ...
            >
              <el-col :xs="24" :lg="12" class="hidden-sm-and-down">
                <div class="home-new-img wow fadeInUp">
                  <img src="@/assets/images/assets-3.png" alt="assets-3" />
                </div>
              </el-col>
              <el-col :xs="24" :lg="8">
                <p class="home-new-title wow fadeInUp">
        ...
        <el-col :xs="24" :lg="18">
          <div class="home-new">
            ...
            >
              ...
              <el-col :xs="24" :lg="12">
                <div class="home-new-img wow fadeInUp">
                  <img src="@/assets/images/assets-4.png" alt="assets-4" />
                </div>
              </el-col>
            </el-row>
          </div>
...
export default {
  ...
  mounted() {
    ...
    this.domGlobal.addEventListener('scroll', this.handleRiskScroll, true);
  },
  destroyed() {
    this.domGlobal.removeEventListener('scroll', this.handleRiskScroll, true);
  },
  methods: {
    handleRiskScroll() {
