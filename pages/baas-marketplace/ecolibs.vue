 ...
 * @LastEditors: abc
 * @LastEditTime: 2021-11-19 19:53:40
 * @Description: ecolibs
-->
<template>
  <div class="other">
    ...
    <div class="bass-appeared" style="display: none">
      <el-row type="flex" justify="center">
        <el-col :xs="24" :sm="22" :md="20" :lg="18">
          <ul class="bass-list">
        ...
        <el-col :xs="24" :lg="18">
          ...
          <div class="bass-case-box">
            <div
              ...
              :key="index"
              class="bass-case-box-item"
            >
              <a :href="item.url" target="_blank" class="bass-case-box-card">
...
export default {
  ...
  head() {
    return {
      title: `${this.$t('home.ecological')} | IBAX Network`,
      meta: [
        {
          hid: 'keywords',
          name: 'keywords',
