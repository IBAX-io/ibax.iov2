          ...
          >
            ...
            <el-col :xs="24" :lg="10">
              <div class="home-new-img wow fadeInUp">
                <img
                  src="../../assets/images/architecture-1.jpg"
                  alt="architecture-1"
                />
              </div>
            </el-col>
        ...
        <el-col :xs="24" :lg="18">
          <div class="home-new">
            ...
            >
              ...
              <el-col :xs="24" :lg="14">
                <div class="home-new-img wow fadeInUp">
                  <img src="../../assets/images/node-1.jpg" alt="node-1" />
                </div>
              </el-col>
            </el-row>
          </div>
      ...
      <el-row type="flex" justify="center" class="el-row-wrap">
        <el-col :xs="24" :lg="18">
          ...
          <div class="media-a-img wow fadeInUp">
            <img src="../../assets/images/node-2.jpg" alt="node-2" />
          </div>
        </el-col>
      </el-row>
    </div>
        ...
        <el-col :xs="24" :lg="18">
          <div class="home-new">
            ...
            >
              ...
              <el-col :xs="24" :lg="14">
                <div class="home-new-img wow fadeInUp">
                  <img src="../../assets/images/node-3.jpg" alt="node-3" />
                </div>
              </el-col>
            </el-row>
          </div>
        ...
        <el-col :xs="24" :lg="18">
          <div class="home-new">
            ...
            >
              ...
              <el-col :xs="24" :lg="14">
                <div class="home-new-img wow fadeInUp">
                  <img src="../../assets/images/node-5.jpg" alt="node-1" />
                </div>
              </el-col>
            </el-row>
          </div>
